/* ==================================================================
 * AuthorizationUtils.java - 13/08/2021 1:48:05 PM
 * 
...
public final class AuthorizationUtils {
  ...
  /**
   * Date formatter that formats or parses a date without an offset, such as '20111203'.
   */
  ...
  /**
   * Date formatter that formats or parses timestamp values in the HTTP {@literal Date} header
   * format, similar to RFC 1123 but with 2-digit day values used always.
   * 
   * <p>
   * An example of this date format is {@literal Fri, 13 Aug 2021 13:55:12 GMT}.
   * </p>
   */
  ...
  /**
   * Date formatter that formats or parses timestamp values in the ISO 8601 condensed timestamp form
   * with second resolution, in the {@code GMT} time zone.
   * 
   * <p>
   ...
   * 
   * @param key
   *          the key to sign the digest with, which is assumed to be a UTF-8 encoded string.
   * @param msg
   *          the message content to sign, which is assumed to be a UTF-8 encoded string.
   * @return the computed digest
   * @throws SecurityException
   *           if the strings cannot be interpreted as UTF-8 or {@code HmacSHA256} is not supported
   *           by the runtime security provider
   */
   ...
   * @return the computed digest
   * @throws SecurityException
   *           if the strings cannot be interpreted as UTF-8 or {@literal HmacSHA256} is not
   *           supported by the runtime security provider
   */
   ...
   * 
   * @param secret
   *          the secret to sign the digest with, which is assumed to be a UTF-8 encoded string.
   * @param msg
   *          the message content to sign, which is assumed to be a UTF-8 encoded string
   * @param alg
   *          the MAC algorithm to use, which must be supported by the runtime security provider
   * @return the computed digest
   * @throws SecurityException
   *           if the strings cannot be interpreted as UTF-8 or {@code alg} is not supported by the
